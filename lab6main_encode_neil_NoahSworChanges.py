...
if __name__ == '__main__':
    ...
    while menu_run:
        ...
        if user_selection == 1:
            ...
            print('error')
# Noah Swor's changes
# added the decode function at the beginning of the file (since it needs to come before it is called in line 43)
# changed multiple "If" statements to be "elif" and "else"
# added an option if the user inputs a number besides 1, 2, or 3.